...
public class Server extends dosyaGonder {
    private static String[] ClientIPs = {"192.168.43.237", "192.168.43.175", "192.168.43.77"}; // Sunucu IP adresleri
    ...
    public void dosyayiIsle() {
        ...
        try {
            ...
            for (int i = 0; i < ClientSayisi; i++) {
                ...
                System.out.println("Sunucuya gönderiliyor: IP = " + ClientIPs[i] + ", Port = " + ports[i]);
                kelimeninGecmeSayisi += dosyaParcasiniGonder(part, arananKelime, ClientIPs[i], ports[i], secilenDosya.getName());
